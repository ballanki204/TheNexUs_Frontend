...
import { ChevronRight, Home, Sparkles, CheckCircle, Calendar, Clock, Shield, Users, Award, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen premium-bg-light">
      ...
      <section className="relative py-24 md:py-32 premium-bg overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-br from-primary/15 via-blue-400/10 to-cyan-400/15 blur-[120px] animate-float opacity-60" style={{ animation: 'mesh-gradient-1 18s ease-in-out infinite' }} />
          <div className="absolute bottom-[-10%] right-[-10%] w-[700px] h-[700px] rounded-full bg-gradient-to-tl from-purple-400/15 via-pink-400/10 to-orange-400/15 blur-[140px] animate-float opacity-60" style={{ animation: 'mesh-gradient-2 20s ease-in-out infinite', animationDelay: '5s' }} />
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4">
          ...
          <div className="mx-auto max-w-4xl text-center mb-16 animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-primary/20 mb-6 animate-slide-up">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider gradient-text">Book Your Session</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-light max-w-3xl mx-auto mb-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Hands-on guidance for Product, Engineering, AI and Growth.
              Get an actionable plan you can implement immediately.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Choose a package and pick a slot that works for you. We provide practical, 
                implementable solutions tailored to your unique needs.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#book">
                <Button size="lg" className="group px-8 py-6 text-lg bg-gradient-to-r from-primary via-blue-500 to-primary hover:from-blue-500 hover:via-primary hover:to-primary text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                  Book a Session
                  <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
                </Button>
              </a>
              <a href="#packages">
                <Button size="lg" variant="outline" className="px-8 py-6 text-lg glass-card border-2 border-primary/30 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 hover:scale-105">
                  See Packages
                </Button>
              </a>
            </div>
          ...
          >
            ...
            {submitted ? (
              <div className="text-center relative z-10">
                ...
                <h3 className="text-3xl font-bold gradient-text mb-4">Booking confirmed 🎉</h3>
                <p className="mt-2 text-lg text-muted-foreground mb-8">
                  We sent a confirmation to <strong className="text-foreground">{form.email}</strong>.
              ...
              <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                <div>
                  ...
                  />
                  {errors.name && (
                    <p className="text-red-600 text-sm mt-1 animate-fade-in">{errors.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.place && (
                    <p className="text-red-600 text-sm mt-1 animate-fade-in">{errors.place}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                    {errors.date && (
                      <p className="text-red-600 text-sm mt-1 animate-fade-in">{errors.date}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.time && (
                      <p className="text-red-600 text-sm mt-1 animate-fade-in">{errors.time}</p>
                    )}
                  </div>
                </div>
        ...
        <section id="packages" className="mt-20">
          <div className="text-center mb-16 animate-slide-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-primary/20 mb-6">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider gradient-text">Our Packages</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((p, index) => (
              <div key={p.id} className="relative group animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div
                ...
                >
                  {/* Gradient Background */}
                  <div className={`absolute inset-0 bg-gradient-to-br from-primary/5 via-blue-500/5 to-purple-500/5 opacity-0 group-hover/package:opacity-100 transition-opacity duration-500`} />
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-muted-foreground mb-6 leading-relaxed text-base">{p.desc}</p>
                    ...
                    >
                      ...
                      <span className="relative z-10">{form.package === p.id ? "✓ Selected" : "Choose Package"}</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <section id="how" className="mt-20">
          <div className="text-center mb-16 animate-slide-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-primary/20 mb-6">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider gradient-text">Simple Process</span>
            </div>
            <h3 className="text-4xl md:text-5xl font-bold gradient-text-extended mb-6">
              How It Works
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { num: 1, title: "Pick a package", desc: "Choose a session length and scope that fits your needs perfectly.", gradient: "from-blue-400 to-purple-500", icon: "🎯" },
              { num: 2, title: "Book & pay", desc: "Confirm your slot and complete secure payment after availability check.", gradient: "from-green-400 to-blue-500", icon: "💳" },
              { num: 3, title: "Get an action plan", desc: "Receive a practical, prioritized plan you can implement right away.", gradient: "from-purple-400 to-pink-500", icon: "📋" },
            ].map((step, index) => (
              <div key={index} className="text-center group animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="relative overflow-hidden glass-card border-2 border-primary/10 p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-500 animate-hover-lift group-hover:border-primary/30">
                  ...
                  <div className="relative z-10">
                    <div className={`w-20 h-20 bg-gradient-to-r ${step.gradient} rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-3xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg`}>
                      {step.num}
                    </div>
        ...
        <section id="testimonials" className="mt-20">
          <div className="text-center mb-16 animate-slide-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-secondary/20 mb-6">
              ...
              <span className="text-xs font-semibold uppercase tracking-wider gradient-text">Client Stories</span>
            </div>
            <h3 className="text-4xl md:text-5xl font-bold gradient-text-extended mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { quote: "Helped us rescue a failing product roadmap — clear, practical, fast.", author: "Priya R., Product Lead", gradient: "from-blue-400 to-cyan-500", color: "text-blue-500" },
              { quote: "The strategy session delivered a 3-step plan we executed in 2 weeks.", author: "Arjun K., Founder", gradient: "from-green-400 to-emerald-500", color: "text-green-500" },
              { quote: "Excellent mix of technical depth and business sense.", author: "Meera S., CTO", gradient: "from-purple-400 to-pink-500", color: "text-purple-500" },
              ...
              <div key={index} className="group animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <blockquote className="relative overflow-hidden glass-card border-2 border-primary/10 p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-500 animate-hover-lift h-full group-hover:border-primary/30">
                  ...
                  <div className="relative z-10">
                    <div className={`${testimonial.color} text-5xl mb-4`}>"</div>
