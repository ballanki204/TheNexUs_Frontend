    ...
    return (
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden apple-background">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-gradient-to-br from-primary/20 via-blue-400/15 to-cyan-400/20 blur-[120px] animate-float opacity-70" style={{ animation: 'mesh-gradient-1 15s ease-in-out infinite' }} />
          <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-gradient-to-tl from-secondary/20 via-emerald-400/15 to-green-400/20 blur-[140px] animate-float opacity-70" style={{ animation: 'mesh-gradient-2 18s ease-in-out infinite', animationDelay: '5s' }} />
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-gradient-to-r from-cyan-300/15 via-blue-400/12 to-purple-400/15 blur-[100px] animate-float opacity-60" style={{ animation: 'mesh-gradient-3 12s ease-in-out infinite', animationDelay: '2s' }} />
        </div>
        ...
        <div className="container relative z-10 py-20 px-4">
          ...
          <div className="absolute inset-0 bg-background/10 backdrop-blur-[80px] -z-10" style={{ background: 'radial-gradient(ellipse 60% 50% at 50% 50%, rgba(255,255,255,0.03), transparent)' }} />
          ...
          <div className="mx-auto max-w-4xl text-center space-y-10 animate-fade-in relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card border border-primary/20 mb-4 animate-slide-up">
              ...
              <span className="text-sm font-medium gradient-text">World-Class Solutions</span>
            </div>
            ...
            <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl lg:text-8xl leading-[1.1] animate-slide-up">
              ...
              <span className="block gradient-text-extended mt-2 bg-clip-text">
                Brighter Future
              </span>
            </h1>

            {/* Description */}
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-light animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            {/* Stats or Features */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-16 pt-8 border-t border-primary/10 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              {[
